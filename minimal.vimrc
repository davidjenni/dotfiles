...
" minimal vimrc without loading any external plugins
" this vimrc can be loaded by itself: vim -u minimal.vimrc
if &compatible
  set nocompatible
endif
...
" emulate some tpope/unimpaired bindings
...
" find files recursively from pwd
set path+=**
if IsWindows()
